            ...
            >
                <div className="relative bg-[var(--bg-primary)] border border-white/10 rounded-lg overflow-hidden hover:border-[#a855f7]/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#a855f7]/10 mx-1">
                    <div className="relative aspect-square">
                        ...
                        <button className="touch-reveal absolute bottom-3 right-3 w-10 h-10 rounded-lg bg-[#a855f7] flex items-center justify-center shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110 hover:bg-[#9333ea]">
