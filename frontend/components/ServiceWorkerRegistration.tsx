...
export function ServiceWorkerRegistration() {
    ...
    return (
        <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-(--z-toast) bg-[var(--bg-hover)] border border-white/10 rounded-lg px-4 py-3 flex items-center gap-3 text-sm whitespace-nowrap">
