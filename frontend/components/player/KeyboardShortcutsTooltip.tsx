...
export function KeyboardShortcutsTooltip() {
    ...
    return (
        <div className="relative">
            ...
            {isVisible && (
                <div className={`${isVisible ? "animate-panel-up" : "animate-panel-down"} absolute bottom-full right-0 mb-2 w-64 bg-[var(--bg-hover)] border border-white/10 rounded-lg shadow-2xl shadow-black/50 p-4 z-(--z-dropdown) backdrop-blur-xl`}>
                    {/* Pointer arrow */}
