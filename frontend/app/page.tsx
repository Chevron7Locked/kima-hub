                                    ...
                                    rightAction={
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 text-xs font-bold uppercase tracking-wider text-black bg-brand hover:bg-[#f97316] rounded-lg transition-colors"
                                            >
